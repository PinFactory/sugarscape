...
class Gui:
    ...
    def __init__(self,sugarscape):
        ...
        self.agent_color_male = pygame.Color(0,180,0)
        self.agent_color_female = pygame.Color(180,0,0)
        ...
        while True:
            ...
            for i in range(scape.length):
                for j in range(scape.width):
                    ...
                    health=loc.get_sugar_amt()/float(5)
                    ...
                    if loc.get_has_agent():
                        pygame.draw.circle(self.window,self.agent_color_female,(int((self.square_length+self.buffer)*i)+int((self.square_length + self.buffer)/2.),
